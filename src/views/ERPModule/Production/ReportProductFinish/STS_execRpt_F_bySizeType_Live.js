...
const STS_execRpt_F_bySizeType_Live = (props) => {
  ...
  const searchSTS_execRpt_F_bySizeType_Live = (daystart, dayend) => {
    ...
    >
      ...
      <Container maxWidth={false}>
        ...
        <Grid container spacing={0} >
          {/* {JSON.stringify(DataSTS_execRpt_F_bySizeType_Live)} */}
          {/* <Grid item xs={12}>
            <Button onClick={searchSTS_execRpt_F_bySizeType_Live}>Search</Button>
...
export default STS_execRpt_F_bySizeType_Live;
