...
import STS_execRpt_F_byType_Live from './STS_execRpt_F_byType_Live';
import STS_execRpt_F_bySize_Live from './STS_execRpt_F_bySize_Live';
import STS_execRpt_F_bySizeType_Live from './STS_execRpt_F_bySizeType_Live';
...
export default function MenuChip(props) {
    ...
    const [openModalItem4, setOpenModalItem4] = React.useState(false);

    const handleCloseModalItem = async () => {
        setOpenModalItem(false);
        setOpenModalItem2(false);
        setOpenModalItem3(false);
        setOpenModalItem4(false);
    };
    ...
    return (
        <span style={{ padding: '0px 3px' }}>
            ...
            >
                ...
                <StyledMenuItem onClick={() => setOpenModalItem4(true)}>
                    <ListItemIcon>
