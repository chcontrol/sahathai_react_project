...
const ReasonStopMachineDetailTableEditable = (props) => {
    ...
    return (
        <MaterialTable
            ...
            icons={tableIcons}
            title={`รายละเอียดสาเหตุที่ต้องหยุดเครื่อง`}
            columns={[
                // { title: 'id', field: 'id', editable: 'never' },
                { title: 'สาเหตุ', field: 'reason_id', type: 'numeric' },
                { title: 'สาเหตุ', field: 'description', type: 'string' },
            ]}
            data={props.dataFormingRecord_description_detail}
...
export default ReasonStopMachineDetailTableEditable;
