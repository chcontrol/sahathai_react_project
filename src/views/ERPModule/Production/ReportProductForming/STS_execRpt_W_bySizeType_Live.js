...
const STS_execRpt_W_bySizeType_Live = (props) => {
  ...
  const searchSTS_execRpt_W_bySizeType_Live = (daystart, dayend) => {
    ...
    API.get(`API_ExecutiveReport/data.php?load=STS_execRpt_W_bySizeType_Live&daystart=${daystart}&dayend=${dayend}`)
      .then(res => {
        setDataSTS_execRpt_W_bySizeType_Live(res.data)
  ...
  useEffect(() => {
    ...
    searchSTS_execRpt_W_bySizeType_Live(props.daystart, props.dayend)
  }, [])
    ...
    >
      ...
      <Container maxWidth={false}>
        ...
        <Grid container spacing={0} >
          {/* {JSON.stringify(DataSTS_execRpt_W_bySizeType_Live)} */}
          {/* <Grid item xs={12}>
            <Button onClick={searchSTS_execRpt_W_bySizeType_Live}>Search</Button>
...
export default STS_execRpt_W_bySizeType_Live;
